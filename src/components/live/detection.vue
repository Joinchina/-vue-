            ...
            <div class="cameradetection" v-show="cameradetection">
                <div class="proinfo">
                    <div class="info_top">
                        <h1>摄像头</h1>
                        <template>
                            <el-select v-model="value" placeholder="请选择" @visible-change="changecamera">
                                <el-option
...
export default {
    ...
    props:[
        'liveController','currentResolution'
    ],
    mounted(){
        this.detescreen();
    ...
    methods:{
        ...
        changecamera(){            
            ...
            // console.log(" this.seis", this.seis)
        },
        camerainfo(val){
            //val为true可以看到，false不可以
            if(this.seis==false){
        ...
        getaudioput(){
            ...
            client.init(AuthInfo.authInfo.appId, function () {
                    console.log("创建频道成功AgoraRTC client initialized");
        ...
        audioinfo(val){
            ...
            if(this.options3.length==0&&val==true){
