                ...
                <el-col :span="15">
                    <div class="grid-content bg-purple-light liveHostBox" >
                        <div class="middleTop">
                            <div class="rightText">
                                <div v-if="!hostFlag">
                                    <img class="volummIcon" src="../../assets/img/liveIcon/sound48.png" alt="">
...
<style lang="less" scoped>
    ...
    .liveItem{
        ...
        .suspensionLayer{
            ...
            overflow: hidden;
            .closedVedio{
                background: url(../../assets/img/liveIcon/close_video_default.png) no-repeat center 6px;
            }
            .openVedio{
                background: url(../../assets/img/liveIcon/open_video_default.png) no-repeat center 6px;
            }
            .closedAudio{
                background: url(../../assets/img/liveIcon/icon_voice-8151f7d0.png) no-repeat center 6px;
            }
            .openAudio{
                background: url(../../assets/img/liveIcon/microphone_default.png) no-repeat center 6px;
            }
            .operaIcon{
