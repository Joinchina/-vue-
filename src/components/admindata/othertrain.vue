    ...
    <div id="zdataaftercontent">
          <div class="tablebox">
            <div class="tabletitle">
                <div class="title"><span></span><h1>其他班级（{{totalElements}}）</h1></div>
                <div class="search">
                    <el-input
                        placeholder="班级名/机构名"
...
export default {
    ...
    //   排序数据
      ...
      //导出讯后数据
      downdata(){
        window.open(API.urls.getdownother+"?token="+getToken())
      }
    },
