		...
		var createObj = {
			...
			saveDraft:function(){
				...
				$("#savePublish").click(function(){
					...
					if(type == "task"){
						var url = devlopMent()+"/course/task?clazzId="+clazzId;
					}else{
						var url = devlopMent()+"/course/detail?clazzId="+clazzId+"&courseId="+courseId;
					}
				...
				$("#savePublishEditor").click(function(){
					  ...
					  var type = $("#belongCourse option:selected").attr("type");
			    ...
			    $("#back_edit").click(function(){
			    	window.location.href = devlopMent()+"/questionare/draft?clazzId="+clazzId;
			    })
			    $("#back").click(function(){
			    	if(type == "task"){
